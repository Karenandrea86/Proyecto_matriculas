...
?>
<h1 class="text-primary"><i class="fas fa-user-plus"></i>  Editar Información de Usuario<small class="text-warning"> Editar</small></h1>
  ...
  <ol class="breadcrumb">
    ...
    <?php
        if (isset($id)) {
            ...
            $query = "SELECT  `name`, `email`, `status` FROM `users` WHERE `id`=$id;";
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select name="status" class="form-control" id="status" required="" value="">
                ...
                <option value="Inactivo" <?= $row['status']=='Inactivo'? 'selected':'' ?>>Inactivo</option>
