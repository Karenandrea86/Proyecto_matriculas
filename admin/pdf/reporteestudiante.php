...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 10, 'REPORTE DE TODOS LOS ESTUDIANTES MATRICULADOS', 0, 1, 'C');
        $this->Ln(10);
    }
...
$sql = "SELECT `id`, `name`, `roll`, `level`, `city`, `pcontact`, `photo`, `datetime`, `acudiente_id` FROM `student_info` ";
